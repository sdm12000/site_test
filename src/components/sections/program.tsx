        ...
        <div className="mt-16 md:mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {pillars.map((pillar, i) => (
            <FadeIn key={pillar.title} delay={0.12 * i}>
              ...
              >
                <div className="flex h-32 w-32 md:h-40 md:w-40 items-center justify-center rounded-full bg-accent text-white shadow-lg shadow-accent/20 transition-shadow group-hover:shadow-xl group-hover:shadow-accent/30">
