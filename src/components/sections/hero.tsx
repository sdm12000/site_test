  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#0b3a66]/80 via-[#0e5aa0]/65 to-[#1c7fd6]/50" />
        {/* Soft light glow on top */}
        <div
          className="absolute inset-0 opacity-45"
          style={{
            background:
              "radial-gradient(ellipse 80% 60% at 20% 50%, rgba(56,189,248,0.35) 0%, transparent 70%), " +
              "radial-gradient(ellipse 60% 80% at 80% 30%, rgba(125,211,252,0.25) 0%, transparent 60%)",
          }}
        />
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        >
          <Link
            href="/program"
            className="rounded-full bg-white px-8 py-3.5 text-base font-medium text-accent-dark shadow-lg shadow-black/20 transition-all hover:bg-white/90 hover:shadow-xl hover:-translate-y-0.5"
          >
            프로그램 알아보기
          </Link>
          <Link
