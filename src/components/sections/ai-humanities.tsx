...
export function AiHumanitiesSection() {
  return (
    <section
      id="ai-humanities"
      className="relative py-24 md:py-32 section-gradient-blue"
    >
            ...
            {features.slice(0, 3).map((feature, i) => {
              ...
              return (
                <FadeIn key={feature.title} delay={0.1 * i}>
                  <div className="group rounded-2xl bg-surface p-7 md:p-8 shadow-lg shadow-accent/5 transition-all duration-300 hover:shadow-xl hover:shadow-accent/10 hover:-translate-y-1 h-full border border-transparent hover:border-accent/10">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-accent/10 text-accent transition-all duration-300 group-hover:bg-accent group-hover:text-white group-hover:shadow-lg group-hover:shadow-accent/20">
