...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    text: "일상 같은 야근으로 인해 여유라고는 점심시간 커피 한잔이 전부였던 저에게 ROOTIVE CLASS는 진정한 힐링의 시간이었어요. 한번도 자신에 대해 깊게 생각해볼 기회가 없었던 저에게, Class를 통해 나 자신을 마주하고 진정한 나의 가치를 발견하게 된 것이 가장 기억에 남습니다.",
  },
  {
    name: "Evan Arnold",
    age: 35,
